        ...
        <div class="flex items-center justify-center py-8 px-2">
            <div class="w-full sm:px-6">
                ...
                >
                    ...
                    <ul>
                        <!-- <div
              class="p-10 grid grid-cols-12 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-3 gap-5"
            > -->
                            ...
                            >
                                <div class="w-full lg:w-1/2">
                                    ...
                                    >
                                        <div class="pb-4">
                                            <p
                                                class="text-sm text-gray-100 flex items-center"
                                            >
                                                <svg
