<template>
  <div
    class="text-gray-100 leading-normal tracking-wider bg-cover"
    style="
      ...
      <div class="w-full sm:px-6">
        <div
          ...
          <div
            ...
            <div
              id="profile"
              class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-gray-800 opacity-100 mx-6 lg:mx-0">
              <div class="p-4 md:p-12 text-center lg:text-left">
                <div
                  ...
                  "></div>
                <p class="text-3xl font-bold pt-8 lg:pt-0">
                  {{ lastname }} {{ firstname }}
                </p>
                <div
                  class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-red-500 opacity-75"></div>
                <p
                ...
                <p
                  class="pt-2 text-gray-100 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                  <svg
                    class="mr-3"
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true"
                ...
                <div class="flex justify-around pt-12 pb-8">
                  <button
                    class="bg-red-600 hover:bg-red-900 text-white font-bold py-2 px-4 rounded-full"
                    @click="editProfil">
                    Modifier
                  </button>
                ...
                <div
                  ...
                  <a
                    ...
                    ><svg
                      class="h-6 fill-current text-red-600 hover:text-red-700"
                      role="img"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg">
