      ...
      <div class="flex shadow-md">
        <div class="w-3/4 bg-black px-8 bg-opacity-75 py-10 rounded-lg">
          ...
          <ul>
            ...
            >
              <div class="p-2">
                <h2 class="text-lg font-black text-red-600">Entrées</h2>
              </div>
            ...
            >
              <div class="p-2">
                <h2 class="text-sm md:text-lg font-black text-red-600">
                  Plats
                </h2>
              </div>
              <li v-for="elem in menu" :key="elem.id">
              ...
              <li v-for="elem in menu" :key="elem.id">
                <div v-if="elem.category === 'dessert'">
                  <div class="w-48 pl-2 justify-between inline-block">
                    ...
                    >
                      <span class="inline-block text-gray-800 font-bold"
                        >{{ elem.name }}
                      </span>
                    </button>
                  </div>
        ...
        >
          ...
          <div v-for="elem in command" :key="elem.id">
            <div class="flex justify-between mt-5 mb-2">
              <span class="font-semibold text-lg">{{ elem }}</span>
              <button
                class="font-semibold text-sm"
                @click="deleteAddition(elem.starter)"
              >
                <svg
...
export default {
  ...
  methods: {
    addEntree(entree, value, id) {
      const starter = entree + " " + value + " €";
      //   const starter = { category: entree, price: value, id: id };
      // console.log(starter);
    ...
    deleteAddition(id) {
      // trouver lors du clique delete
      // récupérer id du plat
      // find index
      // si trouvé alors supprimé
      if (id === this.command.starter.id) {
        this.command.starter.id.splice(0, id);
      }
    },
  },
};
