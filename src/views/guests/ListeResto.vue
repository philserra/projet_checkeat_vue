      ...
      <div
        ...
        <li v-for="elem in liste" :key="elem.id">
          <div class="relative mx-auto w-full">
            <div
              class="absolute -inset-1 bg-gradient-to-r from-red-400 to-red-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
...
export default {
  ...
  async mounted() {
    ...
    const response = await fetch(
      "https://checkeat-api.osc-fr1.scalingo.io/api/guests",
      options
    );
